...
namespace LGP.Components.Database.Postgresql
{
    ...
    public partial class Preferences : IPreferences
    {
        ...
        public void Save()
        {
            ...
            regedit.WriteKey( "PostGrePort" , int.TryParse( port , out intport ) ? intport : 3306 );
        }
        ...
        public void Load( ISettings settingsParent )
        {
            ...
            var regedit = Framework.Registry;
            var port = regedit.ReadKey( "PostGrePort" );
        ...
        {
            return Framework.Images.GetImage( "postgresql" , "VS2010ImageLibrary" , 14 );
        }
